    ...
    <div class="row align-items-center">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            ...
            <div class="pt-20 rounded-top" style="background:
                url(<?= base_url('public/backend/assets/images/background/profile-cover.jpg') ?>) no-repeat;
                  ...
                  pt-4 pb-6 px-4">
                    <div class="d-flex align-items-center">
                      ...
                      align-items-end mt-n10">
                            <img src="<?= base_url() ?>public/img/erwin.png" class="avatar-xxl
                        rounded-circle border border-4 border-white-color-40" alt="">
                            <a href="#!" class="position-absolute top-0 right-0 me-2" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Verified">
                                <img src="<?= base_url() ?>public/backend/assets/images/svg/checked-mark.svg" alt="" height="30" width="30">
                            </a>
                        </div>
                        <!-- text -->
                        <div class="lh-1">
                            <h2 class="mb-0">Erwin, S.Kom
                                <a href="#!" class="text-decoration-none" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Beginner">

                                </a>
                            </h2>
                            <p class="mb-0 d-block">@erwinwing15@gmail.com</p>
                            <p class="mb-0 d-block mt-2">Founder of Titik Balik Teknologi</p>
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <div class="icon-shape icon-lg border p-4 rounded-1">
                                        <img src="<?= base_url() ?>public/backend/assets/images/brand/slack-logo.svg" alt="">
                                    </div>
                                </div>
                                <!-- text -->
                                <div class="ms-3 ">
                            ...
                            <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                ...
                                <div class="avatar-group me-2">
                                    ...
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-1.jpg" class="rounded-circle">
                                    </span>
                                    <!-- img -->
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-2.jpg" class="rounded-circle">
                                    </span>
                                    <!-- img -->
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-3.jpg" class="rounded-circle">
                                    </span>
                                </div>
                                <div>
                                    <!-- dropdown -->
                      ...
                      align-items-center mb-4">
                            <div class="d-flex align-items-center">
                                <div>
                                    <!-- icon shape -->
                                    <div class="icon-shape icon-lg border p-4 rounded-1">
                                        <img src="<?= base_url() ?>public/backend/assets/images/brand/3dsmax-logo.svg" alt="">
                                    </div>
                                </div>
                                <!-- text -->
                                <div class="ms-3 ">
                            ...
                            <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                ...
                                <div class="avatar-group me-2">
                                    <span class="avatar avatar-sm">
                                        <!-- img -->
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-4.jpg" class="rounded-circle">
                                    </span>
                                    <span class="avatar avatar-sm">
                                        <!-- img -->
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-5.jpg" class="rounded-circle">
                                    </span>
                                    <span class="avatar avatar-sm">
                                        <!-- img -->
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-6.jpg" class="rounded-circle">
                                    </span>
                                </div>
                                <div>
                                    <!-- dropdown -->
                      ...
                      align-items-center mb-4">
                            <div class="d-flex align-items-center">
                                <div>
                                    <!-- icon shape -->
                                    <div class="icon-shape icon-lg border p-4 rounded-1">
                                        <img src="<?= base_url() ?>public/backend/assets/images/brand/github-logo.svg" alt="">
                                    </div>
                                </div>
                                <!-- text -->
                                <div class="ms-3 ">
                            ...
                            <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                ...
                                <div class="avatar-group me-2">
                                    <span class="avatar avatar-sm">
                                        <!-- img -->
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-7.jpg" class="rounded-circle">
                                    </span>
                                    <span class="avatar avatar-sm">
                                        <!-- img -->
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-8.jpg" class="rounded-circle">
                                    </span>
                                    <span class="avatar avatar-sm">
                                        <!-- img -->
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-9.jpg" class="rounded-circle">
                                    </span>
                                </div>
                                <div>
                                    <!-- dropdown -->
                      ...
                      align-items-center mb-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="icon-shape icon-lg border p-4 rounded-1">
                                        <img src="<?= base_url() ?>public/backend/assets/images/brand/dropbox-logo.svg" alt="">
                                    </div>
                                </div>
                                <!-- text -->
                                <div class="ms-3 ">
                            ...
                            <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                ...
                                <div class="avatar-group me-2">
                                    <!-- img -->
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-10.jpg" class="rounded-circle">
                                    </span>
                                    <!-- img -->
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-11.jpg" class="rounded-circle">
                                    </span>
                                    <!-- img -->
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-12.jpg" class="rounded-circle">
                                    </span>
                                </div>
                                <div>
                                    <!-- dropdown -->
                      ...
                      align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="icon-shape icon-lg border p-4 rounded-1
                            bg-primary">
                                        <img src="<?= base_url() ?>public/backend/assets/images/brand/layers-logo.svg" alt="">
                                    </div>
                                </div>
                                <!-- text -->
                                <div class="ms-3 ">
                            ...
                            <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                ...
                                <div class="avatar-group me-2">
                                    <!-- img -->
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-13.jpg" class="rounded-circle">
                                    </span>
                                    <!-- img -->
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-14.jpg" class="rounded-circle">
                                    </span>
                                    <!-- img -->
                                    <span class="avatar avatar-sm">
                                        <img alt="avatar" src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-15.jpg" class="rounded-circle">
                                    </span>
                                </div>
                                <div>
                                    <!-- dropdown -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-1.jpg" alt="" class="avatar avatar-md rounded-circle">
                                </div>
                                <div class="ms-3">
                        ...
                        <div class="mb-4">
                            ...
                            <img src="<?= base_url() ?>public/backend/assets/images/blog/blog-img-1.jpg" class="rounded-3 w-100" alt="">
                        </div>
                        <!-- icons -->
                        <div class="mb-4">
                      ...
                      align-items-center mb-4">
                        ...
                        <div class="row">
                            <div class="col-xl-1 col-lg-2 col-md-2 col-12 mb-3 mb-lg-0">
                                <!-- avatar -->
                                <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-1.jpg" class="avatar avatar-md rounded-circle" alt="">
                            </div>
                            <!-- input -->
                    ...
                    <div class="card-body">
                      ...
                      align-items-center mb-4">
                            <div class="d-flex align-items-center">
                                <!-- img -->
                                <div>
                                    <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-1.jpg" class="rounded-circle avatar-md" alt="">
                                </div>
                                <!-- text -->
                                <div class="ms-3 ">
                            ...
                            <div>
                                <a href="#" class="text-muted text-primary-hover"><i class="me-4 icon-xs" data-feather="phone-call"></i></a>
                                <a href="#" class="text-muted text-primary-hover"><i class="icon-xs" data-feather="video"></i></a>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between
                      align-items-center mb-4">
                            <div class="d-flex align-items-center">
                                <!-- img -->
                                <div>
                                    <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-2.jpg" class="rounded-circle avatar-md" alt="">
                                </div>
                                <!-- content -->
                                <div class="ms-3 ">
                      ...
                      align-items-center mb-4">
                            <div class="d-flex align-items-center">
                                <!-- img -->
                                <div>
                                    <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-3.jpg" class="rounded-circle avatar-md" alt="">
                                </div>
                                <!-- text -->
                                <div class="ms-3 ">
                      ...
                      align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-4.jpg" class="rounded-circle avatar-md" alt="">
                                </div>
                                <!-- text -->
                                <div class="ms-3 ">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex mb-5">
                                    <!-- img -->
                                    <div>
                                        <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-6.jpg" class="rounded-circle avatar-md" alt="">
                                    </div>
                                    <!-- content -->
                                    <div class="ms-3 ">
                                        <h5 class="mb-1">Dianna Smiley</h5>
                                ...
                                <div class="d-flex mb-5">
                                    <!-- img -->
                                    <div>
                                        <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-7.jpg" class="rounded-circle avatar-md" alt="">
                                    </div>
                                    <!-- content -->
                                    <div class="ms-3 ">
                                ...
                                <div class="d-flex">
                                    <!-- img -->
                                    <div>
                                        <img src="<?= base_url() ?>public/backend/assets/images/avatar/avatar-9.jpg" class="rounded-circle avatar-md" alt="">
                                    </div>
                                    <!-- content -->
                                    <div class="ms-3 ">
